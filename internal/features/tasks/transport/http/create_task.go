...
type CreateTaskRequest struct {
	...
	Description  *string `json:"description" validate:"omitempty,min=1,max=1000"     example:"Do homework till Thursday"`
...
//	@Accept			json
//	@Produce		json
//	@Param			request	body		CreateTaskRequest					true	"Body of a task to create"
