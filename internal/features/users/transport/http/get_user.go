...
//	@Tags			users
//	@Produce		json
//	@Param			id	path		int									true	"ID of the user to get"
//	@Success		200	{object}	GetUserResponse						"The user is successfully found"
//	@Failure		400	{object}	core_http_response.ErrorResponse	"Bad request"
//	@Failure		404	{object}	core_http_response.ErrorResponse	"The user is not found"
